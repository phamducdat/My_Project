...
create table student (
	student_id UUID  NOT NULL default uuid_generate_v1(),
...
create table english (
    english_id UUID NOT NULL default uuid_generate_v1(),
...
create table subject (
	...
	constraint fk_subject foreign key(institute_id) references institute(institute_id)
);
